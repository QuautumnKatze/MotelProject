...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-lg-6">
                <h4 class="fw-bold py-3 mb-4">Sửa tải khoản</h4>
            </div>
        </div>
        <div class="container mt-3">
            <form method="POST" action="edit-user-handler.php">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    <div>
                                        <img src="../<?= $user['avatar'] ?>" class="d-block rounded" height="350"
                                            id="uploadedImage" />
                                    </div>
                                ...
                                <div>
                                    <input type="text" class="form-control mt-2" id="fileName" name="avatar" value="<?= $user['avatar'] ?>"
                                        placeholder="No file selected" readonly />
                                </div>
                                <div class="mt-2 mb-3">
                                    <label for="largeInput" class="form-label">ID</label>
                                    <input id="largeInput" class="form-control form-control-lg" type="text"
                                        placeholder="ID" name="id" value="<?= $user['id'] ?>" readonly />
                                </div>
                                <div class="mt-2 mb-3">
                                    <label for="largeInput" class="form-label">Tên tải khoản</label>
                                    <input id="largeInput" class="form-control form-control-lg" type="text"
                                        placeholder="Tên tài khoản" value="<?= $user['username'] ?>" name="username"
                                        required />
                                </div>
                                <div class="mt-2 mb-3">
                                ...
                                <div class="mt-2 mb-3">
                                    ...
                                    <input id="largeInput" class="form-control form-control-lg" type="password"
                                        placeholder="Mật khẩu" value="<?= $user['password'] ?>" name="password"
                                        required />
                                </div>
                                <div class="mt-2 mb-3">
                                ...
                                <div class="mt-2 mb-3">
                                    ...
                                    <input id="largeInput" class="form-control form-control-lg" type="text"
                                        placeholder="SDT" value="<?= $user['phone'] ?>" name="phone" required />
                                </div>
                                <div class="mt-2 mb-3">
                                    <label for="largeSelect" class="form-label">Phân loại</label>
                                    <select id="largeSelect" name="role" class="form-select form-select-lg">
                                        <option value="1" <?php echo $user['role'] == 1 ? "selected" : ""; ?>>Người dùng
                                        </option>
                                        <option value="0" <?php echo $user['role'] == 0 ? "selected" : ""; ?>>Quản trị
                                            viên</option>
                                    </select>
                                </div>
